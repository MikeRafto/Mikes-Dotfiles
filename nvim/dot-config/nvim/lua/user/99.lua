local status_ok, _99 = pcall(require, "99")
...
-- Ensure Gemini CLI trusts workspaces when run in headless mode
vim.env.GEMINI_CLI_TRUST_WORKSPACE = "true"

local cwd = vim.uv.cwd()
local basename = vim.fs.basename(cwd)
_99.setup({
	provider = _99.Providers.GeminiCLIProvider, -- default: OpenCodeProvider
	provider_extra_args = { "--skip-trust" },
	logger = {
		level = _99.DEBUG,
...
vim.keymap.set("n", "<leader>9t", function()
	_99.tutorial()
end, { desc = "99: Interactive Tutorial" })
